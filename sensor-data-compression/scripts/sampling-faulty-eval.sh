...
LOGFILE=/home/olivia/xdr/econ-t/fastml-science/sensor-data-compression/faulty-eval/end-of-life-emd-sampling-ber1e-4-test.csv

# Sanity check
echo "Sanity check ber = 0"
python3 sampling_faulty_eval.py \
	-i $DATASET \
	-o ${OUTPUT_DIR}/ber0 \
	--AEonly 1 \
	--nELinks 5 \
