...
python3 autoencoder_pyhessian_analysis.py \
    ...
    --batch_size 500 \
    --cuda \
    --checkpoint ./pt_train/named_layers_autoencoder_elegun/named_layers_autoencoder_elegun_epoch=95_loss=0.006.ckpt \
    --model-tag bol_minibatch500 \
    --logfile ./logs/autoencoder_mean_hessian_trace.csv
    # --checkpoint ./pt_train/named_layers_autoencoder_hgcal/last.ckpt \
